...
- [ ] Add fuller maintenance-agent active task state, transcript retention/search/redaction, and tool-enabled maintenance chat once proposal governance covers generated writes.
