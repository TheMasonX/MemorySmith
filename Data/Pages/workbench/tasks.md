...
| Done | Copilot | Delete page/chat confirmation | Shared destructive-action confirmation now covers Page, Memory, Chat, Profile-link, and Model-profile deletes/removals with consistent copy and recovery guidance. | Pending |
