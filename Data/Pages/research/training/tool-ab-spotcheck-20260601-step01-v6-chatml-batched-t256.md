# Tool A/B Spot Check - 20260601-step01-v6-chatml-batched-t256 (Base vs Tuned)

Generated: 2026-06-01 07:17:14Z
...
- Raw results JSON: `Data/Pages/research/training/tool-ab-spotcheck-20260601-step01-v6-chatml-batched-t256.data.json`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| `memorysmith_code_search` | 5 | 0/5 (0.0%) | 0/5 (0.0%) | 5/5 (100.0%) | 0/5 (0.0%) | +5 | +0 |
| `memorysmith_code_search_status` | 5 | 0/5 (0.0%) | 0/5 (0.0%) | 5/5 (100.0%) | 0/5 (0.0%) | +5 | +0 |
| `memorysmith_context_pack` | 5 | 0/5 (0.0%) | 0/5 (0.0%) | 5/5 (100.0%) | 0/5 (0.0%) | +5 | +0 |
...
| `memorysmith_search` | 5 | 0/5 (0.0%) | 0/5 (0.0%) | 3/5 (60.0%) | 2/5 (40.0%) | +3 | +2 |
| `memorysmith_semantic_search` | 5 | 0/5 (0.0%) | 0/5 (0.0%) | 5/5 (100.0%) | 1/5 (20.0%) | +5 | +1 |
| `memorysmith_task_get` | 5 | 0/5 (0.0%) | 0/5 (0.0%) | 4/5 (80.0%) | 0/5 (0.0%) | +4 | +0 |
| `memorysmith_task_list` | 5 | 0/5 (0.0%) | 0/5 (0.0%) | 4/5 (80.0%) | 0/5 (0.0%) | +4 | +0 |
...
- `memorysmith_semantic_search-3` (memorysmith_semantic_search): base(match=False, env=False, pred=None) -> tuned(match=False, env=True, pred=semantic_search); prompt="semantic search for sidebar collapse standard"
...
- `memorysmith_unified_search-2` (memorysmith_unified_search): base pred=None, tuned pred=None, baseErr=No JSON object found, tunedErr=toolCalls missing or empty
...
- `memorysmith_semantic_search-3` (memorysmith_semantic_search): base pred=None, tuned pred=semantic_search, baseErr=No JSON object found, tunedErr=None
...
- `memorysmith_semantic_search-5` (memorysmith_semantic_search): base pred=None, tuned pred=semantic_search, baseErr=No JSON object found, tunedErr=None
- `memorysmith_search-1` (memorysmith_search): base pred=None, tuned pred=memorysmith_search_memories, baseErr=No JSON object found, tunedErr=None
