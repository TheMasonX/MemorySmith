...
- A/B run launched:
  ...
  - adapter: `D:/temp/memorysmith-training/runs/20260601-085001/adapter`
- Current state: in progress at time of summary write; final JSON artifact not emitted yet.
