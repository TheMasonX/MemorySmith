...
public sealed partial class MemoryChatAgent : IChatAgent
{
    ...
    // FormatRecordAsync, Read*Query, Format*Results — moved to ChatToolCatalog.cs (dead in ChatServices)
    ...
    // ShouldPreloadContext + 6 regex fields — moved to ChatContextPlanner.cs (dead in ChatServices)
