...
public sealed class AdminSettingsService
{
    ...
    [
        ...
        EditableSettingDescriptor.Choice("MemorySmith:Chat:Provider", "Default chat provider", "Chat", settings => settings.Chat.Provider, ["Ollama", "GitHubCopilot", "OpenAI"], "Default provider selected for MemorySmith chat when a request does not explicitly choose a provider. Provider capability metadata is shown in chat config."),
        ...
        EditableSettingDescriptor.String("MemorySmith:Chat:OpenAIEndpoint", "OpenAI-compatible endpoint", "Chat", settings => settings.Chat.OpenAIEndpoint, 500, "Base URL for OpenAI-compatible APIs (DeepSeek, OpenAI, OpenRouter, etc.). Defaults to https://api.deepseek.com when blank."),
        EditableSettingDescriptor.String("MemorySmith:Chat:OpenAIApiKeyEnvironmentVariable", "OpenAI API key env var", "Chat", settings => settings.Chat.OpenAIApiKeyEnvironmentVariable, 100, "Environment variable name holding the API key for OpenAI-compatible providers. Default: MSA_LLM_API_KEY (same as MemorySmith.Agent for credential sharing)."),
        EditableSettingDescriptor.String("MemorySmith:Chat:OpenAIModel", "OpenAI-compatible model", "Chat", settings => settings.Chat.OpenAIModel, 100, "Default model name for OpenAI-compatible chat requests (e.g. deepseek-chat, gpt-4o)."),
